...
namespace MercadoEnvio.Mappings
{
    class Factura
    {
        ...
        public DataTable TraerFacturasNuevasPersonas(String query)
        {

            BasedeDatosForm bd = new BasedeDatosForm();
            bd.openConnection();
            SqlCommand cmd = new SqlCommand("SELECT * FROM [RECUR].[NuevasFacturasVendedores]" + query, bd.conexion);
        ...
        public DataTable TraerFacturasNuevasEmpresas(String query)
        {

            BasedeDatosForm bd = new BasedeDatosForm();
            bd.openConnection();
            SqlCommand cmd = new SqlCommand("SELECT * FROM [RECUR].[NuevasFacturasEmpresas]" + query, bd.conexion);
